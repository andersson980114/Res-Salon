 ...
 * @author ander
 */
public class proPrincipal extends javax.swing.JFrame {

    /**
     * Creates new form proPrincipal
     */
    public int codUsuaraio;
    public proPrincipal(int codUsuaraio) {
        this.codUsuaraio = codUsuaraio;
        initComponents();
        this.setLocationRelativeTo(null);
       //this.gstAdmi.setSelected(true);
       new CambiaPanel(PrincipalPane, new usuarioHome(codUsuaraio));
    }
