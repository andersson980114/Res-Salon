 ...
 * @author ander
 */
public class VigPrincipal extends javax.swing.JFrame {

    /**
     * Creates new form VigPrincipal
     */
    public int codUsuario;
    public VigPrincipal(int codUsuario) {
    ...
    private void initComponents() {
        ...
        regSalida = new Vista.recurso.RSButtonMetro();
        modData = new Vista.recurso.RSButtonMetro();
        regEnt = new Vista.recurso.RSButtonMetro();
        ...
        regSalida.setColorHover(new java.awt.Color(255, 255, 255));
        regSalida.setColorNormal(new java.awt.Color(255, 0, 0));
        regSalida.setColorPressed(new java.awt.Color(222, 4, 4));
        regSalida.setColorTextHover(new java.awt.Color(255, 0, 0));
        ...
        regEnt.setText("Registrar Entrada");
        regEnt.setColorHover(new java.awt.Color(255, 255, 255));
        regEnt.setColorNormal(new java.awt.Color(255, 0, 0));
        regEnt.setColorPressed(new java.awt.Color(222, 4, 4));
        regEnt.setColorTextHover(new java.awt.Color(255, 0, 0));
        regEnt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                regEntActionPerformed(evt);
            }
        });
        ...
        DesplegableLayout.setHorizontalGroup(
            ...
            .addComponent(regSalida, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, DesplegableLayout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(regEnt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        DesplegableLayout.setVerticalGroup(
            ...
            .addGroup(DesplegableLayout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(regEnt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(regSalida, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void regSalidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regSalidaActionPerformed
        new CambiaPanel(PrincipalPane, new regSalidaPane());
    ...
    private void regEntActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regEntActionPerformed

        new CambiaPanel(PrincipalPane, new regEntradaPane());

    }//GEN-LAST:event_regEntActionPerformed
    ...
    private Vista.recurso.RSButtonMetro regEnt;
    private Vista.recurso.RSButtonMetro regSalida;
